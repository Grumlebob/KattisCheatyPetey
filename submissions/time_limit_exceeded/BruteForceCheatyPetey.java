                ...
                for (int currentCardValue : valuesAvailable) {
                    ...
                    if (currentTarget - currentCardValue >= 0) {
                        ...
                        if (dp[currentTarget - currentCardValue] + 1 < dp[currentTarget]
                                && valuesAvailableFrom[currentTarget - currentCardValue]
                                        .numberOf(currentCardValue) > 0) {
                            valuesAvailableFrom[currentTarget] = valuesAvailableFrom[currentTarget - currentCardValue]
                                    .clone();
